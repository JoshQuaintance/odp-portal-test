[OntologyDesignPatterns.org](Main_Page "Main Page") __is a Semantic Web portal dedicated to ontology design patterns (ODPs)__, run by the [ODPA](ODPA "http://ontologydesignpatterns.org/wiki/ODPA").
