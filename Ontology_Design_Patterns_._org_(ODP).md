[OntologyDesignPatterns.org](Main_Page.md "Main Page") __is a Semantic Web portal dedicated to ontology design patterns (ODPs)__, run by the [ODPA](ODPA.md "http://ontologydesignpatterns.org/wiki/ODPA").
